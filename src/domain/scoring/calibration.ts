export const CALIBRATION_VERSION = 1 as const;
...
export const BASELINE_WEIGHT = 0.75;
export const DAILY_MAX_WEIGHT = 0.25;
...
// CALIBRATION_VERSION 1 values are provisional MVP values and may be tuned after pilot testing.
