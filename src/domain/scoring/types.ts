...
export interface DerivedAnalysis { calibrationVersion: number; scores: AbilityScores; baselineScores: AbilityScores; tendencies: Tendency[]; dominantTendency: Tendency | null; stability: StabilityByAbility; profile: ProfileResult; certifications: Record<Ability, CertificationTier>; finalMetrics: { mostStable: FinalMetric; mostConditionSensitive: FinalMetric; mostPositivelyUpdated: FinalMetric }; crossInsights: CrossInsight[]; selectedFinalAbility: Ability | null }
