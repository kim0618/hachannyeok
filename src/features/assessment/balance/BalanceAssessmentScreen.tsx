...
export function BalanceAssessmentScreen(props: Props) {
  ...
  return <div className="screen balance-screen ready-screen"><header className="progress-header"><span>균형 분배</span><span>3 / 5</span></header><section className="ready-content" aria-labelledby="balance-ready-title"><p className="eyebrow">세 번째 측정</p><h1 id="balance-ready-title">균형 분배</h1><p>영역이 정확히 반반이라고 느껴지는 곳에 선을 놓아주세요.<br />숫자로 재지 말고 눈대중으로 해보세요.</p></section><div className="bottom-action"><PrimaryButton onClick={assessment.startTrial}>시작하기</PrimaryButton></div></div>;
}
