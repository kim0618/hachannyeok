...
import { CenterInstrument, InstrumentReadyContent } from '../AssessmentInstruments';
...
export function CenterAssessmentScreen(props: Props) {
  ...
  return <div className="screen center-screen ready-screen"><header className="progress-header"><span>중심 감각</span><span>2 / 5</span></header><InstrumentReadyContent instrument={<CenterInstrument />} eyebrow="두 번째 측정" titleId="center-ready-title" title="중심 감각">도형의 정확한 가운데라고 느껴지는 곳을 눌러주세요.<br />너무 오래 고민하지 않아도 됩니다.</InstrumentReadyContent><div className="bottom-action"><PrimaryButton onClick={assessment.startTrial}>시작하기</PrimaryButton></div></div>;
}
