...
interface Props { onNext: () => void; clock?: MeasurementClock; dateNow?: () => Date; createTrialId?: () => string; frameScheduler?: FocusFrameScheduler }
